package classwork_40_6_11.supermarket_heshset.test;

import classwork_40_6_11.supermarket_heshset.dao.SupermarketImpl;
...
class SupermarketImplTest {
    ...
    @Test
    void findByCategory() {
        HashSet<Product> actual = (HashSet<Product>) supermarket.findByCategory ("Bread");//безопасный кастинг
        int l = actual.size();
