...
import classwork_46_14_11.AIT.toDoList.ToDoListAppl;
import java.io.*;
...
public class ToDoListImpl implements ToDoList {
    ...
    public Task removeTask(int taskNumber) {
        ...
        System.out.println("Wrong number of task.");//Неправильный номер задачи
        return null;
    }

    @Override
    public void viewTasks() {//view - вид
...
//        }
    ...
    @Override
    public void saveTasks(String fileName) {//saveTasks - сохранение задач
    ...
    @Override
    public void loadTasks(String fileName) {//loadTasks - загружать задачи
        ...
        } catch (FileNotFoundException e) {//FileNotFoundException - Файл не найден Исключение
            throw new RuntimeException(e);//RuntimeException - Исключение во время выполнения
        } catch (IOException e) {
            throw new RuntimeException(e);
        } catch (ClassNotFoundException e) {//Класс не найден Исключение
            throw new RuntimeException(e);
        }
    }
}
