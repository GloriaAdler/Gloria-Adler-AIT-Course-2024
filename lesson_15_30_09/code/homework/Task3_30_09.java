package homework;
//Задание 3 (*). Дано предложение: "В 1800-х годах, в те времена, когда не было еще ни железных, ни шоссейных дорог,
// ни газового, ни стеаринового света, ни пружинных низких диванов, ни мебели без лаку, ни разочарованных юношей со стеклышками,
...
// ехали восемь суток по мягкой, пыльной или грязной дороге и верили в пожарские котлеты, в валдайские колокольчики и бублики, –
// когда в длинные осенние вечера нагорали сальные свечи, освещая семейные кружки из двадцати и тридцати человек,
...
// мартинистов, тугендбунда, во времена Милорадовичей, Давыдовых, Пушкиных, – в губернском городе К. был съезд помещиков,
...
//189 слов - проверено в ворде, 1065 букв - проверено в блокноте
public class Task3_30_09 {
    public static void main(String[] args) {
        ...
        System.out.println("Numbers of words in sentence: " + countWords(sentence));

        // Выводим количество букв (сюда не входят цифры, пробелы, знаки)
        System.out.println("Numbers of letters in sentence: " + countLetters(sentence));
    }//end of main

    // Метод для подсчета слов в предложении
    public static int countWords(String sentence) {
// Удаляем тире, чтобы программа не считала его как отдельное слово, разбиваем строку по пробелам и знакам препинания
        String[] words = sentence.replace("–", "").trim().split("\\s+");
        return words.length;
    }
    // Метод для подсчета букв в предложении
    public static int countLetters(String sentence) {
// Убираем все символы, кроме букв в маленьком и большом регистре
        String lettersOnly = sentence.replaceAll("[^а-яА-Я]", "");
