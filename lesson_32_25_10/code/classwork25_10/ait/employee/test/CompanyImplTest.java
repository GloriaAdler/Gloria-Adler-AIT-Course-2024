package classwork25_10.ait.employee.test;

import classwork25_10.ait.employee.dao.Company;
import classwork25_10.ait.employee.dao.CompanyImpl;
import classwork25_10.ait.employee.model.Employee;
import classwork25_10.ait.employee.model.Manager;
import classwork25_10.ait.employee.model.SalesManager;
import classwork25_10.ait.employee.model.Worker;
...
//!!!!!
    ...
    void findEmployeesHoursGreaterThanTest() {
        ...
        Employee[] overworkedEmployees = company.findEmployeesHoursGreaterThan(160);
        // Проверяем, что нашли двух сотрудников
        assertEquals(4, overworkedEmployees.length);
    ...
    void findEmployeeSalaryRangeTest() {
        ...
        Employee[] employeesInRange = company.findEmployeesSalaryRange(3401, 11999);
        // Проверяем, что нашли двух сотрудников
        assertEquals(4, employeesInRange.length);//employeesInRange.length
