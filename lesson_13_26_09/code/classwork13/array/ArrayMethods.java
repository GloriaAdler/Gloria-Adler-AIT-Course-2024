...
public class ArrayMethods {
    ...
    public static int linearSearch (int[]array, int n){//если использовать void тогда придется чтото дополнительно выводить на экран, а int через return сам выводит, какую -либо инфу на экран
