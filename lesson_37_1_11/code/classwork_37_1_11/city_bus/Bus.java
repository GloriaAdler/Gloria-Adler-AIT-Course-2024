package classwork_37_1_11.city_bus;
...
public class Bus implements Comparable <Bus>{
    ...
    public int compareTo(Bus o) {
        return - Integer.compare(this.getBusCapacity(), o.getBusCapacity());//Integer.compare - сортировка от меньшего к большему, - Integer.compare - от большего к меньшему
    }
}
